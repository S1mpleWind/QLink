...
template <> constexpr inline auto GameMenu::qt_create_metaobjectdata<qt_meta_tag_ZN8GameMenuE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<GameMenu, qt_meta_tag_ZN8GameMenuE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject GameMenu::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameMenuE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameMenuE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8GameMenuE_t>.metaTypes,
    nullptr
} };
...
void GameMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameMenu::*)()>(_a, &GameMenu::resumeClicked, 0))
            return;
...
void *GameMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameMenuE_t>.strings))
